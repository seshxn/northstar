...
export const resolveEnvValue = (value: unknown, opts: ResolveOpts = {}): unknown => {
...
export const resolvePathValue = (value: unknown, fallback: string, opts: ResolveOpts = {}): string => {
...
export const deepResolveEnv = <T>(value: T, opts: ResolveOpts = {}): T => {
